...
function mapboxwebapis_get_directions_v5_mapbox_profile_origin_latorigin_lngdest_latdest_lngjson_list(payload) {
  return mapBoxWebAPIs.get(`/directions/v5/mapbox/profile/origin_lat,origin_lng:dest_lat,dest_lng.json`, {
    params: {
      access_token: payload.access_token
    }
  });
